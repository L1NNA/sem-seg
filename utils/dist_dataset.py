...
class DistDataset(Dataset):
    ...
    def __init__(self, config:Config, name, stage):
        ...
        self.tokens:List[List[Tuple[List[str], str]]] = []
    ...
    def get_all(self, i, j, seq_len) -> Iterator[Tuple[int, int, str]]:
